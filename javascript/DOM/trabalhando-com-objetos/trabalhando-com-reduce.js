...
}
{
    ...
    let valorEmEstoque = valoresProduto.reduce(function (total, numero) {
        return (total += numero);
    });

    console.log(valoresProduto);
    console.log(
        'Valores do meu estoque',
        valorEmEstoque.toLocaleString('pt-BR', {
            style: 'currency',
            currency: 'BRL'
        })
    );
}
/*Reduce -  objeto de transformar um array em um único valor, uma lista em um único valor */
{
