...
*/
{
    ...
    function processaTexto(funcaoCallBack) {
        // VOID
...
{
    let exibeResultadoOperacao = resultado => {
        // VOID
        console.log(resultado);
    };

    let somaDoisNumeros = exibeResultado => {
        //VOID
...
let somaDoisNumerosOutroModelo = (a, b) => {
