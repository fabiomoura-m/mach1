...
// console.log('Digite um número inteiro entre 2 e 1000:');
// let numero = Number(prompt());
// if (!Number.isInteger(numero) || isNaN(numero) || numero < 2 || numero > 1000) {
//   console.log('Insira um número inteiro entre 2 e 1000');
//   return;
// }

// let valoresDescrescentes = '';
// for (let i = numero; i >= 1; i--) {
//   valoresDescrescentes += i;
// }

// console.log(`Entre os números ${numero} e 1: ${valoresDescrescentes}`);
