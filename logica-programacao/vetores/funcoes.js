...
console.log(
    'Transforma o array em string e voce tem a possiblidade escolher o separador'
);
...
console.log(
    'Adiciona um ou mais elementos ao final de um array e retorna o novo tamanho desse array.'
);
console.log(carros.push('City', 'HRV')); //Adicionar o HRV depois do City no array carros
...
console.log(
    'Adiciona um ou mais elementos no início de um array e retorna o número de elementos'
);
console.log(carros.unshift('Ka', 'Cruze')); //Adicionar o Ka e Cruze no inicio do array
//console.log(carros.push("Ka")); //Adicionar o Ka no inicio do array
//console.log(carros.push("Cruze")); //Adicionar o Cruze no inicio do array
console.table(carros);
...
console.log('Remove elementos dentro do array');
console.log(carros.splice(4, 1)); // indice do array, quantidade de itens a ser removido
console.table(carros);
...
console.log(
    'retorna o ultimo índice que um certo elemento pode ser encontrado no array, ou -1 se o elemento não estiver presente.'
);
